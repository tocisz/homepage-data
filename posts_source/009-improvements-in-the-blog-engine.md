...
date: 2019-02-07 abstract: A few improvements in blog engine. Syntax coloring, RSS and more.

## Improvements in the blog engine

In [the last blog entry](https://github.com/tocisz/homepage-data/tree/91ea770f294bef72d09c2ec36c76105606dd7c4a/posts_source/008-Migrating-to-AWS/README.md) I was writing how I generate pages of this blog with Python scripts running on AWS Lambda. Since that time I did a few improvements. I will shortly write about them in this follow up article.
